...
def genetic_algorithm(A, B):
    ...
    def generate_population():
        # Generate a population of individuals with 5 actuator positions
        return [sorted(random.sample(range(num_elements), 5)) for _ in range(population_size)]
    ...
    def mutate(individual):
        ...
        if random.random() < mutation_prob:
            ...
            while len(individual) < 5:  # Ensure 5 actuators are always present
...
if __name__ == "__main__":
    ...
    # Step 2: Visualize Piezoelectric Placement
    ...
    # Step 4: Plot Vibration Response
